                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-between pt-8 border-t border-gray-200">
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-8 py-3 rounded-xl flex items-center gap-3 font-semibold shadow-lg hover:shadow-xl transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isLoading ? (
                                        <>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
                        ...
                        {isLoading ? (
                            ...
                            <div className="space-y-6">
                                <div className="relative w-full h-[550px] rounded-2xl overflow-hidden border-2 border-orange-200">
                                    <Image
                                    ...
                                    <div className="space-y-3">
                                        <div className="grid grid-cols-2 gap-3">
                                            <a
                                                ...
                                                download
                                                className="px-4 py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold text-center hover:scale-105 transition-all flex items-center justify-center gap-2"
                                            >
                                                <Download size={16} />
                                                Download
                                            </a>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="flex gap-3 pt-4 border-t border-gray-200">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold hover:scale-105 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
                                >
