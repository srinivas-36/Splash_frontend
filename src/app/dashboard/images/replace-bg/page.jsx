    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#fcfcfc] via-[#f8f7ff] to-[#f5f3ff] p-8">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 left-10 w-40 h-40 bg-gradient-to-r from-[#884cff]/10 to-[#5a2fcf]/10 rounded-full blur-3xl"></div>
                <div className="absolute bottom-1/4 right-10 w-40 h-40 bg-gradient-to-r from-[#884cff]/5 to-[#5a2fcf]/5 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#884cff]/10 to-[#5a2fcf]/10 rounded-full w-fit border border-[#884cff]/20">
                        <Star className="w-4 h-4 text-[#884cff]" />
                        <span className="text-sm font-medium text-[#884cff]">Most Popular Tool</span>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label className="block text-lg font-semibold text-[#1a1a1a] mb-4 flex items-center gap-2">
                                    <Upload className="w-5 h-5 text-[#884cff]" />
                                ...
                                >
                                    ...
                                    {productPreview ? (
                                        ...
                                        <div className="text-center">
                                            <Upload className="w-12 h-12 text-[#884cff] mx-auto mb-3" />
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {referencePreview ? (
                                        ...
                                        <div className="text-center">
                                            <ImageIcon className="w-12 h-12 text-[#884cff] mx-auto mb-3" />
                            ...
                            <div>
                                <label className="block text-lg font-semibold text-[#1a1a1a] mb-4 flex items-center gap-2">
                                    <Settings className="w-5 h-5 text-[#884cff]" />
                                    Background Color
                                </label>
                                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-[#f8f7ff] to-[#f5f3ff] rounded-2xl border border-[#e6e6e6]">
                                    ...
                                    <input
                                        ...
                                        value={formData.backgroundColor}
                                        onChange={(e) => setFormData((prev) => ({ ...prev, backgroundColor: e.target.value }))}
                                        className="flex-1 px-4 py-3 border border-[#e6e6e6] rounded-xl bg-white text-[#1a1a1a] font-mono focus:outline-none focus:ring-2 focus:ring-[#884cff] focus:border-transparent"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <label className="block text-lg font-semibold text-[#1a1a1a] mb-4 flex items-center gap-2">
                                    <Sparkles className="w-5 h-5 text-[#884cff]" />
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 border border-[#e6e6e6] rounded-xl bg-white text-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-[#884cff] focus:border-transparent resize-none"
                                    rows="3"
                                />
                            </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
                        ...
                        {isLoading ? (
                            ...
                            <div className="space-y-6">
                                <div className="relative w-full h-[450px] rounded-2xl overflow-hidden border-2 border-[#884cff]/20">
                                    <Image
